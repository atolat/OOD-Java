...
public class ECommerceApp {
    ...
    public static void main(String[] args) {
        ...
        ECommerceApp myFlipKart = new ECommerceApp();
        ...
        digiElectronics.registerProduct(new Product("Mobile","Latest Technology",10000.00,electronics,5),
                myFlipKart.productsCatalog);

        // Seller Digi Electronics adding Camera to myFlipKart catalog
        digiElectronics.registerProduct(new Product("Camera","Advanced Technology",50000.00,electronics,10), //
                myFlipKart.productsCatalog);

        // Seller FashionPoint adding Wearbles to myFlipKart catalog
        fashionPoint.registerProduct(new Product("Mens Jackets","XL - Size",1000.00,clothing,10), //
                myFlipKart.productsCatalog);

        fashionPoint.registerProduct(new Product("Jackets","XL - Size",1000.00,clothing,10), //
                myFlipKart.productsCatalog);

        // Seller FashionPoint adding Cosmetics to myFlipKart catalog
        fashionPoint.registerProduct(new Product("Nail Paint","Red Color",500.00,cosmetics,25), //
                myFlipKart.productsCatalog);

        // Seller dailyNeedsGrocery adding grocery to myFlipKart catalog
        dailyNeedsGrocery.registerProduct(new Product("Sugar","Fine quality",40.00,grocery,1000), //
                myFlipKart.productsCatalog);

        // Seller dailyNeedsGrocery adding grocery to myFlipKart catalog
        dailyNeedsGrocery.registerProduct(new Product("Milk","100% Pure",50.00,grocery,250), //
                myFlipKart.productsCatalog);

        dailyNeedsGrocery.registerProduct(new Product("Toned Milk","Hygenic and Pure",45.00,grocery,250), //
                myFlipKart.productsCatalog);

        dailyNeedsGrocery.registerProduct(new Product("Milk Cream","Natural",145.00,grocery,100), //
                myFlipKart.productsCatalog);
